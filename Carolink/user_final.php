...
// Fetch organizations
$org_sql = "SELECT organization_id, name, profile_picture FROM Organizations";
...
<div class="main-content">
    <div class="posts-header">
        <h1 style="padding-right: 40px;">Recent</h1>
            ...
            <?php if (is_null($post['post_type'])): // Check if the post is made by a user ?>
                <div class="post">
                    ...
                    <div class="user-post-actions">
                        <!--
                        <button class="btn-like" data-post-id="<?php echo $post['post_id']; ?>" data-liked="false">
